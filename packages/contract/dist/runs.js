import { z } from 'zod';
import { runnerSchema, runnerSelectionSchema } from './health.js';
import { referenceStatusSchema } from './github.js';
...
import { workflowDefSchema, workflowStepDefSchema } from './workflows.js';
/**
 ...
 */
export const referenceStatusesByProjectSchema = z.record(z.string(), z.object({
 ...
 */
export const createRunInputSchema = createRunInputBaseSchema.refine((b) => Boolean(b.workflow) !== Boolean(b.steps), { message: 'provide either "workflow" or "steps", not both' });
/**
