 ...
 *  else only reads. */
export function setApiScope(projectId) {
...
export function apiBase() {
    const scoped = activeProjectId === null ? '' : `/p/${encodeURIComponent(activeProjectId)}`;
 ...
 */
const WORKSPACE_LEVEL = /^\/(?:health$|models(?:$|[/?])|providers(?:$|[/?])|projects(?:$|[/?])|workspace\/|fs\/)/;
/**
...
function scopeRoute(route) {
    if (activeProjectId === null || WORKSPACE_LEVEL.test(route))
        return route;
