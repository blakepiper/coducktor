 ...
 */
export declare function createCezarClient<T extends Hono<any, any, any> = Hono>(options?: CezarClientOptions): ReturnType<typeof hc<T>>;
/**
 ...
 */
export type Ok<R> = R extends ClientResponse<infer T, infer S, 'json'> ? S extends SuccessStatusCode ? T : never : never;
/**
