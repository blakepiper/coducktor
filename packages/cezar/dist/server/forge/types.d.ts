...
export type ForgeTimelineEventKind = 'committed' | 'labeled' | 'unlabeled' | 'assigned' | 'unassigned' | 'merged' | 'closed' | 'reopened' | 'head_ref_force_pushed' | 'cross-referenced' | 'renamed';
...
export interface ForgeDriver {
    ...
    prMergeState?(number: number, opts?: {
        refresh?: boolean;
