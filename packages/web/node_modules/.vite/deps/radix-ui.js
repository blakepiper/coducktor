...
import { A as useId, C as Root$11, D as dist_exports$24, E as createSlottable, F as composeEventHandlers, M as createContextScope, O as useControllableState, P as useComposedRefs, S as Primitive, T as createSlot, _ as FocusScope, a as DialogOverlay, b as Root$12, c as DialogTrigger, d as hideOthers, f as ReactRemoveScroll, g as dist_exports$17, h as Portal$4, i as DialogDescription, j as useLayoutEffect2, k as useEffectEvent, l as createDialogScope, m as Presence, n as DialogClose, o as DialogPortal, p as useFocusGuards, r as DialogContent, s as DialogTitle, t as Dialog, u as dist_exports$8, v as Branch, w as dispatchDiscreteCustomEvent, x as useCallbackRef, y as DismissableLayer } from "./dist-CmEmv_bz.js";
...
var AccessibleIcon = ({ children, label }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [import_react.cloneElement(child, {
		"aria-hidden": "true",
		focusable: "false"
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$10, { children: label })] });
};
...
var TRIGGER_NAME$14 = "CollapsibleTrigger";
var CollapsibleTrigger = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeCollapsible, ...triggerProps } = props;
	const context = useCollapsibleContext(TRIGGER_NAME$14, __scopeCollapsible);
...
CollapsibleTrigger.displayName = TRIGGER_NAME$14;
var CONTENT_NAME$13 = "CollapsibleContent";
var CollapsibleContent = import_react.forwardRef((props, forwardedRef) => {
	const { forceMount, ...contentProps } = props;
	const context = useCollapsibleContext(CONTENT_NAME$13, props.__scopeCollapsible);
...
CollapsibleContent.displayName = CONTENT_NAME$13;
var CollapsibleContentImpl = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeCollapsible, present, children, ...contentProps } = props;
	const context = useCollapsibleContext(CONTENT_NAME$13, __scopeCollapsible);
...
var Trigger$8 = CollapsibleTrigger;
...
var TRIGGER_NAME$13 = "AccordionTrigger";
var AccordionTrigger = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAccordion, ...triggerProps } = props;
	const accordionContext = useAccordionContext(ACCORDION_NAME, __scopeAccordion);
	const itemContext = useAccordionItemContext(TRIGGER_NAME$13, __scopeAccordion);
	const collapsibleContext = useAccordionCollapsibleContext(TRIGGER_NAME$13, __scopeAccordion);
	const collapsibleScope = useCollapsibleScope(__scopeAccordion);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$8.ItemSlot, {
		scope: __scopeAccordion,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trigger$8, {
...
AccordionTrigger.displayName = TRIGGER_NAME$13;
var CONTENT_NAME$12 = "AccordionContent";
var AccordionContent = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAccordion, ...contentProps } = props;
	const accordionContext = useAccordionContext(ACCORDION_NAME, __scopeAccordion);
	const itemContext = useAccordionItemContext(CONTENT_NAME$12, __scopeAccordion);
	const collapsibleScope = useCollapsibleScope(__scopeAccordion);
...
AccordionContent.displayName = CONTENT_NAME$12;
...
var FormLabel = import_react.forwardRef((props, forwardedRef) => {
	...
	const fieldContext = useFormFieldContext(LABEL_NAME$2, __scopeForm, { optional: true });
	const name = nameProp ?? fieldContext?.name;
	if (!name) throw new Error(`\`${LABEL_NAME$2}\` must be used within \`${FIELD_NAME}\` or specify the \`name\` prop`);
	const htmlFor = labelProps.htmlFor || fieldContext?.id;
	if (!htmlFor) throw new Error(`\`${LABEL_NAME$2}\` must be used within \`${FIELD_NAME}\` or specify the \`htmlFor\` prop`);
...
var FormControl = import_react.forwardRef((props, forwardedRef) => {
	...
	const name = nameProp || fieldContext?.name;
	if (!name) throw new Error(`\`${CONTROL_NAME}\` must be used within \`${FIELD_NAME}\` or specify the \`name\` prop`);
	const id = idProp || fieldContext?.id;
	if (!id) throw new Error(`\`${CONTROL_NAME}\` must be used within \`${FIELD_NAME}\` or specify the \`id\` prop`);
...
var FormMessage = import_react.forwardRef((props, forwardedRef) => {
	...
	const name = nameProp ?? fieldContext?.name;
	if (!name) throw new Error(`\`${MESSAGE_NAME}\` must be used within \`${FIELD_NAME}\` or specify the \`name\` prop`);
...
var FormValidityState = (props) => {
	...
	const name = nameProp ?? fieldContext?.name;
	if (!name) throw new Error(`\`${VALIDITY_STATE_NAME}\` must be used within \`${FIELD_NAME}\` or specify the \`name\` prop`);
...
var HoverCard = (props) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HoverCardProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root2$7, {
			...popperScope,
			children
		})
	});
...
var NavigationMenuTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$10, {
		"aria-hidden": true,
		tabIndex: 0,
...
var NavigationMenuViewportItem = ({ contentRef, isActive, onActiveContentChange, ...props }) => {
	const composedRefs = useComposedRefs(contentRef, import_react.useCallback((node) => {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.Provider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.Slot, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$6, {
					...
					orientation,
					dir: direction,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$11.div, {
						...domProps,
						role: "group",
						ref: composedRefs,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
			...
			children: ({ hasTabStop, isCurrentTabStop }) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$11.input, {
...
var PasswordToggleField = ({ __scopePasswordToggleField, ...props }) => {
	...
	} else onVisibilityChange = props.onVisibilityChange;
	import_react.useEffect(() => {
		if (shouldWarn) console.warn("PasswordToggleField: The misspelled `onVisiblityChange` prop has been removed. Please use `onVisibilityChange` instead.");
	}, [shouldWarn]);
...
var SwitchTrigger = import_react.forwardRef(({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) => {
	const { control, form, value, disabled, checked, required, setControl, setChecked, hasConsumerStoppedPropagationRef, isFormControl, bubbleInput } = useSwitchContext(TRIGGER_NAME$2, __scopeSwitch);
	const composedRefs = useComposedRefs(forwardedRef, setControl);
	const initialCheckedStateRef = import_react.useRef(checked);
	import_react.useEffect(() => {
